...
//	$.Msg( "_ScoreboardUpdater_UpdateAllTeamsAndPlayers: ", scoreboardConfig );
	...
	{		
		var teamPanel = teamsContainer.FindChild("_dynamic_team_"+teamId);
		var val = 0;
		if (teamPanel) {
			val = teamPanel.GetAttributeInt("team_score__", 0);
		}
		var deets = Game.GetTeamDetails( teamId );
		deets.team_score = val;
		
		teamsList.push( deets );
	}
